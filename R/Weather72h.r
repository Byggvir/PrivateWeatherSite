...
ggsave(  
  file = paste( outdir,'temperature_',Zeitraum,'h.svg', sep='')
  , plot = P
  , device = 'svg'
  , bg = "white"
  , width = 1920
...
ggsave(  
  file = paste( outdir,'humidity_',Zeitraum,'h.svg', sep='')
  , plot = P
  , device = 'svg'
  , bg = "white"
  , width = 1920
...
ggsave(  
  file = paste( outdir,'air_pressure_',Zeitraum,'h.svg', sep='')
  , plot = P
  , device = 'svg'
  , bg = "white"
  , width = 1920
...
ggsave(
  file = paste( outdir,'solarradiation_',Zeitraum,'h.svg', sep='')
  , plot = P
  , device = 'svg'
  , bg = "white"
  , width = 1920
...
ggsave(  
  file = paste( outdir,'windspeed_',Zeitraum,'h.svg', sep='')
  , plot = P
  , device = 'svg'
  , bg = "white"
  , width = 1920
...
ggsave(  
  file = paste( outdir,'winddir_',Zeitraum,'h.svg', sep='')
  , plot = P
  , device = 'svg'
  , bg = "white"
  , width = 1920
...
ggsave(  
  file = paste( outdir,'wind_',Zeitraum,'h.svg', sep='')
  , plot = P
  , device = 'svg'
  , bg = "white"
  , width = 1920
